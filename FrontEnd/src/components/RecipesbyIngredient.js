...
function Recipes() {
  ...
  <button onClick={() => setcategory(ingredient._id)}>{ ingredient.ingredient }</button>
);

const List = ingredientStore.ingredient.filter((ingredient)=> ingredient._id === ingredientt ).map((ingredient) => ingredient.recipe)
console.log(List)
  return (
    <>
      <Nav />
